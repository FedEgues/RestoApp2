...
/**
 *Implementa palabras clave en el lenguaje de programación Java que se utiliza para implementar una interfaz por una clase. 
 * Una interfaz en Java es un tipo abstracto que se utiliza para especificar un contrato que debe ser implementado por clases, que implementan esa interfaz. 
 * Por lo general, una interfaz solo contendrá firmas de métodos y declaraciones constantes. Cualquier interfaz que implemente una interfaz particular debe implementar todos los métodos definidos en la interfaz, o debe declararse como una clase abstracta.
 * En Java, el tipo de una referencia de objeto se puede definir como un tipo de interfaz. Pero ese objeto debe ser nulo o debe contener un objeto de una clase, que implementa esa interfaz en particular.
 * Al utilizar la palabra clave Implements en Java, puede implementar múltiples interfaces en una sola clase. Una interfaz no puede implementar otra interfaz. Sin embargo, una interfaz puede extender una clase.
 * 
 * La palabra clave Implements se usa para que una clase implemente una interfaz determinada, mientras que la palabra clave Extends se usa para que una subclase se extienda desde una súper clase. Cuando una clase implementa una interfaz, 
 * esa clase necesita implementar todos los métodos definidos en la interfaz, pero cuando una subclase extiende una súper clase, puede o no reemplazar los métodos incluidos en la clase primaria.
 * @author Federico
 */
@Service
public class UsuarioServicio implements UserDetailsService {
    ...
    @Transactional
    public void registroUsuario(String nombre,String apellido,String mail,String clave1,String clave2)throws ErrorServicio{
